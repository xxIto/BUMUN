...
<head>
  ...
  <title>Website Resmi Kampung Bumun | Sistem Informasi Desa</title>
...
<body>
  ...
  <div class="mainheader">
    <div id="header-wrapper">
      <div class="chanelmenumobile">
        <button class="button1" id="hamburgerButton" onclick="toggleMenu()"><i aria-hidden="true" class="fa fa-2x fa-align-right"></i></button>
      </div>
      <!-- Logo -->
        ...
        <div class="widget Header" data-version="1" id="Header1">
          <div id="header-inner">
            <a href="#" style="display: block">
              <img alt="" height="162px; " id="Header1_headerimg" src="https://1.bp.blogspot.com/-k469O7yJKVk/YaLwnAZAXoI/AAAAAAAAB-Y/XuFLomE__NYv2C9sMddrF0uwuDE1JJguQCLcBGAsYHQ/s483/logo%2Bgodesa.png" style="display: block" width="483px; " />
            </a>
          </div>
        </div>
      </div>
            ...
            <div class="menubar">
              <ul>
                ...
                <li class="last"><a onclick="$(&#39;.menudrop1&#39;).slideToggle();" title="Profil"> <i class="fa fa-user-circle"></i>
                  ...
                  <ul class="menudrop1">
                    <li><a href="profile/sejarah.php" title="Sejarah Desa">Sejarah </a></li>
                ...
                <li><a href="" title=" Kontak Desa "><i class="fa fa-wpforms fa-wpforms"></i> Kontak </a></li>
              </ul>
            </div>
          </div>
          <div class="clear"></div>
  ...
  <div id="ml_9ce0bfaa">
    ...
    <!-- Cuaca -->
    <div id="ml_9ce0bfaa_c" style="padding: 0; margin: 0; padding: 7px 5px; "><img src="https://cuacalab.id/assets/img/logo_z_w.svg" style="width: 15px; opacity: 0.7; margin-right: 5px; position: relative; top: 50%; transform: translateY(-6px); vertical-align: top;display: inline-block;">
      <a href="https://cuacalab.id/cuaca_sumatra_utara/" style="vertical-align:baseline;padding:0;margin:0;color:inherit;text-decoration:none;display:inline-block;box-sizing: border-box;padding:0 5px;font-size:14px;line-height:14px;position:relative;top:50%;transform:translateY(-7px);vertical-align:top;" target="_blank" id="ml_9ce0bfaa_u">
        Cuaca
      </a>
    </div>
  </div>
  ...
  <div id="blog-outer">
    <div id="wrap2">
      <div id="content-wrapper">
        ...
        <div class="newpostd">Kampung Bumun</div>
        <p class="paragraph">
          Kampung BUMUN merupakan kampung yang terletak di distrik Eligobel, Kabupaten Merauke, Provinsi Papua Selatan. Sebelah utara kampung bumun berbatasan dengan kampung Tof-Tof/Bupul VII, Sebelah Selatan barbatasan dengan kampung Bupul Indah VII/Bupul V, sebalah timur berbatasan dengan hutan, sebelah barat berbatasan dengan kampung Bunggay/Bupul VIII.
        </p>
        <p class="paragraph">
          Kampung BUMUN didirikan pada tanggal 25 Februari 1997. Kampung BUMUN adalah bekas kampung transmigrasi yang pada saat itu dipimpin oleh KUPT (sutinjak) bersama dua orang stafnya (Fransiskus T, dan Suwarno). Kampung BUMUN diambil dari nama/jalan yang bersejarah perang suku YEINAN dan BIAN ANEM memakai jalan bumun melintas Tengah kampung, maka disebut kampung BUMUN.
        </p>
        <p class="paragraph">
          Luas pada pemukiman kampung BUMUN kurang lebih 1.538 HA yang dengan perincian 80 kepala keluarga, dimna setiap keluarga memiliki 2 HA tanah telah di sertifikasikan dengan demikian luas 660 HA, tanah bendali atau kolam tadah air (KTA) 6 HA, Tanah pemakaman dengan luas 1 HA, tanah restan dengan luas 4 HA.
        </p>
        <!-- End Tentang Kami -->
