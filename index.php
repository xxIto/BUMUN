                    ...
                    <div class="widget-content">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <a href=""><img src="assets/img/banner-bumun.png" /></a>
                                <div class="carousel-caption">
                                    <h3>Selamat Datang</h3>
                                    <p> di Website Kampung Bumun</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="widget-content">
                        <center>
                            ...
                            <div class="box-counter text-center">
                                ...
                                <div class="counter">
                                    <h5 class="counter-number white">
                                        <span class="counter-timer" data-from="0" data-to="420">285</span>
                                    </h5>
                                    <h5 class="counter-title white">Jarak ke Pemerintah Kota</h5>
                                </div>
                                <div class="counter">
                                    <h5 class="counter-number white">
    ...
    <div id="blog-outer">
        <div id="wrap2">
            <div id="content-wrapper">
                ...
                <div class="newpost"> Tentang Desa </div>
                <div class="newpostd">Kampung Bumun</div>
                <div id="menustatic2-wrapper">
                    <div class="menustatic2 section" id="menustatic2">
                        <div class="widget HTML" data-version="1" id="HTML6">
                            <div class="widget-definisi">
                                <!-- Note : Tambahkan class indent di dalam tag span untuk menggunakan spasi panjang -->
                                <p class="definisi" style="text-align: justify;">
                                    <span class="">Kampung BUMUN merupakan kampung yang terletak di distrik Eligobel, Kabupaten Merauke, Provinsi Papua Selatan. Sebelah utara kampung bumun berbatasan dengan kampung Tof-Tof/Bupul VII, Sebelah Selatan berbatasan dengan kampung Bupul Indah VII/Bupul V, sebalah timur berbatasan dengan hutan, sebelah barat berbatasan dengan kampung Bunggay/Bupul VIII.</span>
                                </p>
                                <p class="definisi" style="text-align: justify;">
                                    <span class="">Kampung BUMUN didirikan pada tanggal 25 Februari 1997. Kampung BUMUN adalah bekas kampung transmigrasi yang pada saat itu dipimpin oleh KUPT (sutinjak) bersama dua orang staffnya (Fransiskus T, dan Suwarno). Kampung BUMUN diambil dari nama/jalan yang bersejarah perang suku YEINAN dan BIAN ANEM memakai jalan bumun melintas Tengah kampung, maka disebut kampung BUMUN.</span>
                                </p>
                                <p class="definisi" style="text-align: justify;">
                                    <span class="">Luas pada pemukiman kampung BUMUN kurang lebih 1.538 HA yang dengan perincian 80 kepala keluarga, dimna setiap keluarga memiliki 2 HA tanah telah di sertifikasikan dengan demikian luas 660 HA, tanah bendali atau kolam tadah air (KTA) 6 HA, Tanah pemakaman dengan luas 1 HA, tanah restan dengan luas 4 HA.</span>
                                </p>
                            </div>
                            <div class="clear"></div>
                        </div>
                            ...
                            <div class="widget-content">
                                <center>
                                    <ul class="mediapartner0">
                                        ...
                                        <li><a href="web/agenda desa.php">
                                                <i aria-hidden="true" class="fa fa-calendar fa-lg  map-marker"></i>
                                                <h6> Agenda</h6>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="doc/tatib.pdf" target="_blank" class="pdf-link" title="Tekan untuk download">
